 ...
 */
case class InfoPage[A](items: Seq[A], page: Int, offset: Long, total: Long) {
...
object Computer {
	 ...
	 */
	def list(page: Int = 0, pageSize: Int = 20, orderBy: Int = 1, filter: String = "%"): InfoPage[(Computer, Option[Company])] = {
		...
		DB.withConnection {
          ...
          where computer.name like {filter}
				...
				InfoPage(computers, page, offest, totalRows)
